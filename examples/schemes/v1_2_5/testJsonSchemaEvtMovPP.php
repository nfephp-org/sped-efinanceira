...
$std->infoprevpriv[0]->plano = new \stdClass();
$std->infoprevpriv[0]->plano->tpplano = '02';
$std->infoprevpriv[0]->plano->planofechado = 1;
$std->infoprevpriv[0]->plano->cnpjplano = '12345678912345';
$std->infoprevpriv[0]->plano->tpplanofechado = 1;
...
//salva se sucesso
file_put_contents("../../$evento.schema", $jsonSchema);
