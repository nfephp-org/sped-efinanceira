...
$config = [
    ...
    'eventoVersion' => '1_2_5', //versão do layout do evento
...
$std->infoprevpriv[0]->produto->opcaotributacao = 1; //opcional

//opcional <Plano>
$std->infoprevpriv[0]->plano = new \stdClass();
$std->infoprevpriv[0]->plano->tpplano = '02'; //obrigatório
$std->infoprevpriv[0]->plano->planofechado = 1; // obrigatório
